...
#   branch = main
#   token  = projects/<project_number>/secrets/dataform-github-token/versions/latest
# apply 前にシークレット dataform-github-token を作る（README ⑥）。
# 上書きするときだけ:
# dataform_git_url             = "https://github.com/Ysakairi/credit_detect_dataform.git"
# dataform_github_token_secret = "projects/your-gcp-project-number/secrets/dataform-github-token/versions/latest"
